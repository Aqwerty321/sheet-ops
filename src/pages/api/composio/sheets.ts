 ...
 */
export default route("/api/composio/sheets", {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        try {
          ...
          return Response.json({ error: "Invalid drive response", sheets: [], debug: driveDataText });
        }
      ...
      try {
        ...
        return Response.json({ error: "Invalid response", sheets: [], debug: responseText });
      }
  ...
  post: async ({ request }) => {
    ...
    try {
      ...
      try {
        ...
        return Response.json({ error: "Invalid response", debug: responseText });
      }
